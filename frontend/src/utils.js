export const COLUMN_DEFS = [
  ...
  { key: "implied_team_total", label: "Implied", type: "number", precision: 1, bar: true, optional: true },
  { key: "moneyline", label: "ML", type: "number", odds: true, bar: true, lowerIsBetter: true, optional: true },
  { key: "anytime_goal_odds", label: "Goal Odds", type: "number", odds: true, bar: true, lowerIsBetter: true, optional: true },
